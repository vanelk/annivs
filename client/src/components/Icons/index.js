...
export const Home = ()=> <span className={styles.icon_home}></span>
...
export const ExternalLink  = () => <span className={styles.icon_external_link}></span>
export const Ellipsis  = () => <span className={styles.icon_ellipsis}></span>